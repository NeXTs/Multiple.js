...
$(function() {
  ...
  function fillTweets(amount) {
    ...
    tweets = shuffle([
      ...
      {lang: 'en', used: false, markup: '<blockquote class="twitter-tweet" data-cards="hidden" data-lang="en"><p lang="en" dir="ltr">Multiple.js: Sharing background across multiple elements using CSS <a href="https://t.co/D9jpoXxiU0">https://t.co/D9jpoXxiU0</a> via <a href="https://twitter.com/DenisLukov">@denislukov</a> <a href="https://t.co/FxGkbDQEUZ">pic.twitter.com/FxGkbDQEUZ</a></p>&mdash; Product Hunt (@ProductHunt) <a href="https://twitter.com/ProductHunt/status/758483911752155136">July 28, 2016</a></blockquote>'}
    ]),
    result = [];
